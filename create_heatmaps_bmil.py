	...
	for i in range(len(process_stack)):
		try:
			...
			if os.path.isfile(os.path.join(r_slide_save_dir, heatmap_save_name)):
				...
				heatmap_data_uncs = drawHeatmap(uncs, coords, slide_path, uncs_type=0, wsi_object=wsi_object, cmap=heatmap_args.cmap,
				...
				heatmap_total_uncs = drawHeatmap(uncs, coords, slide_path, uncs_type=1, wsi_object=wsi_object,
				...
				heatmap_model_uncs = drawHeatmap(uncs, coords, slide_path, uncs_type=2, wsi_object=wsi_object,
												 cmap=heatmap_args.cmap,
												 alpha=heatmap_args.alpha, use_holes=True, binarize=False, vis_level=-1,
												 blank_canvas=False,
												 thresh=-1, patch_size=vis_patch_size, convert_to_percentiles=True)
